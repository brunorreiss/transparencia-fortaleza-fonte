...
logger_name = env.get('BOT_NAME', default='transparencia-fortaleza-fonte')
...
#---------------------------- Application -------------------------------
app = FastAPI(
    title='REST API - Consulta Portal Transparência Fortaleza - Fonte', 
    description=desc, 
    debug=False, 
    openapi_tags=tags_metadata,
    openapi_url="/api/transparencia-fortaleza-fonte/consulta/docs/openapi.json",
    docs_url='/api/transparencia-fortaleza-fonte/consulta/docs'
)
...
#---------------------------- Endpoints -------------------------------
@app.get(
    path=f"/api/transparencia-fortaleza-fonte/consulta", 
    tags=['transparencia-fortaleza-fonte'],
    responses=responses)
